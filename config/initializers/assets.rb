...
Rails.application.config.assets.precompile += %w( 
	...
	client/comment.scss client/photo.scss
)
Rails.application.config.assets.precompile += %w(admin/layout.scss admin/layout.js admin/form.scss admin/kaminari.scss)
